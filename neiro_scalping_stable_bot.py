...
def get_prices():
    ...
    def calc_ratio(depth):
        ...
        return round(buy_pct), round(100 - buy_pct)

    neiro_buy, neiro_sell = calc_ratio(neiro_depth)
    btc_buy, btc_sell = calc_ratio(btc_depth)
